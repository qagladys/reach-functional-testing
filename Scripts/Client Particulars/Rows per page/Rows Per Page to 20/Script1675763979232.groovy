...
WebUI.click(findTestObject('Client particulars page/Dashboard/Rows per page/Option_Rows per page_20'))

WebUI.scrollToElement(findTestObject('Client particulars page/Dashboard/Rows per page/Text_Rows per page'), 5)

WebUI.verifyElementText(findTestObject('Client particulars page/Dashboard/Rows per page/Button_Rows per page'), '20')
